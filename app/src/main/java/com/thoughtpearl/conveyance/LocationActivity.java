...
import com.thoughtpearl.conveyance.ui.CustomDialog;
 ...
 */
public class LocationActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapLoadedCallback {
            ...
            new Handler().postDelayed(() -> {
                if (mMap != null) {
                    mMap.snapshot(bitmap -> {
                        ...
                        LocationApp.showLoader(LocationActivity.this);
                        startService(intent);
                        stopLocationUpdates();
                    });
                }
